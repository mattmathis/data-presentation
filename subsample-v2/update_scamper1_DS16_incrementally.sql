# update_scamper1_DS16_incrementally
#
# DML script
...
/* FIRST TIME ONLY
CREATE OR REPLACE TABLE `mlab-collaboration.mm_preproduction.scamper1_DS16`
  PARTITION BY date
AS ( SELECT *,
...
SET replace_day = (SELECT MAX(date) FROM `mlab-collaboration.mm_preproduction.scamper1_DS16` WHERE date >= '2026-01-01');
