# Inventory scamper2_DS16
# Compares row counts between measurement-lab.ndt.scamper2 and the 1/16 subsample per date.
...
ds16 AS (
  ...
  FROM `mlab-collaboration.mm_preproduction.scamper2_DS16`
  WHERE date >= CURRENT_DATE() - 30
  GROUP BY date
),
report AS (
